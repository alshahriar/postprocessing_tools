...
if(isunix)
    ...
    iterS(userDirCaseNumber) = 570; iterE(userDirCaseNumber) = 0;
    
    userDirCaseNumber = userDirCaseNumber + 1;
    dirName{userDirCaseNumber} = '/gpfs/home/as17r/engineering/ParametricStudy/AllCases2/Thermal_Coupling_Test_Cases/OldSetup/';
    folderNames{userDirCaseNumber} = 'test32_corr'; %issue
    iterS(userDirCaseNumber) = 223; iterE(userDirCaseNumber) = 0;
    
    userDirCaseNumber = userDirCaseNumber + 1;
    dirName{userDirCaseNumber} = '/gpfs/home/as17r/engineering/ParametricStudy/AllCases2/Thermal_Coupling_Test_Cases/OldSetup/';
    folderNames{userDirCaseNumber} = 'test33_corr'; %issue
    iterS(userDirCaseNumber) = 168; iterE(userDirCaseNumber) = 437;
    ...
    iterS(userDirCaseNumber) = 1028; iterE(userDirCaseNumber) = 0;
    
    
    userDirCaseNumber = userDirCaseNumber + 1;
    dirName{userDirCaseNumber} = '/gpfs/home/as17r/engineering/ParametricStudy/AllCases2/Thermal_Coupling_Test_Cases/OldSetup/';
    folderNames{userDirCaseNumber} = 'test32_2';
    iterS(userDirCaseNumber) = 100; iterE(userDirCaseNumber) = 0;
...
for caseNumber = 1:totalNumberOfCases
    ...
    for iVar = 1:nVar_xt_temp
        ...
        contourf(xxx,tt,xtV',50,"edgeColor","none")
